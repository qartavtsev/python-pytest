...
def test_add_dynamic_att(parametr1, parametr2):
    ...
    with allure.step('Шаг 2: Создание вложения HTML.'):
        allure.attach(f'<h1>Example html attachment</h1> <h2>У {parametr1} {parametr2} колеса.</h2>', name='HTML example', attachment_type=allure.attachment_type.HTML  )

    with allure.step('Шаг 3: Создание вложения TXT.'):
        allure.attach(f'У {parametr1} {parametr2} колеса.', name='TXT example', attachment_type=allure.attachment_type.TEXT)
